...
**Purpose:** form practitioners and surface real problems from churches, ministries, and nonprofits.

**Hand-off criteria into a hackathon:** a problem is ready to be taken into a hackathon when it has an identified partner, a specific pain point (not a vague "we need an app"), and someone from the partner side willing to show up and explain it. See [`docs/playbooks/create-night-format.md`](../playbooks/create-night-format.md).

> TODO(quinn): confirm how problems are actually captured and vetted during Create before being brought to a hackathon.
